...
print("Число 11 ",convert(11))
print("Число 26 ",convert(26))
print("Число -11 ",convert(-11))
print("Число -26 ",convert(-26))

a=re.split(" ", convert(11)[0])[2]
b=re.split(" ", convert(26)[0])[2]
c=re.split(" ", convert(-11)[0])[2]
d=re.split(" ", convert(-26)[0])[2]
...
print("Обратный код")
a=re.split(" ", convert(11)[1])[2]
b=re.split(" ", convert(26)[1])[2]
c=re.split(" ", convert(-11)[1])[2]
d=re.split(" ", convert(-26)[1])[2]
...
a=re.split(" ", convert(11)[2])[2]
b=re.split(" ", convert(26)[2])[2]
c=re.split(" ", convert(-11)[2])[2]
d=re.split(" ", convert(-26)[2])[2]
